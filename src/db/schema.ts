...
export const examTypes = mysqlTable(
  'exam_types',
  {
    ...
    registrationEndAt: timestamp('registration_end_at', { mode: 'date' }),
    examStartAt: timestamp('exam_start_at', { mode: 'date' }),
    examEndAt: timestamp('exam_end_at', { mode: 'date' }),
    announcementAt: timestamp('announcement_at', { mode: 'date' }),
    informationContent: longtext('information_content'),
    ...auditColumns(),
  },
