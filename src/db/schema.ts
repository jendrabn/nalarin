...
export const questions = mysqlTable(
  'questions',
  {
    ...
    manualExplanation: longtext('manual_explanation'),
    aiExplanation: longtext('ai_explanation'),
...
export const practices = mysqlTable(
  'practices',
  {
    ...
    hasPracticeMode: boolean('has_practice_mode').notNull(),
    hasQuizMode: boolean('has_quiz_mode').notNull(),
