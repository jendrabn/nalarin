...
export function QuestionAiExplanation({
  ...
  return (
    ...
    >
      ...
      {html ? (
        <div
          className="mt-4 text-sm leading-7 [&_h3]:mb-2 [&_h3]:mt-4 [&_h3:first-child]:mt-0 [&_h3]:font-semibold [&_li]:mb-1 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-3 [&_ul]:list-disc [&_ul]:pl-5"
