...
const privacySections = [
  {
    ...
    items: [
      ...
      "Data subscription dan payment, termasuk plan yang dipilih, status pembayaran, bukti pembayaran, nominal transaksi, dan riwayat approval admin.",
  ...
  },
  {
    ...
    items: [
      ...
      "Memproses pembayaran melalui metode pembayaran yang tersedia, memverifikasi transaksi, mencegah payment pending ganda, dan menangani webhook secara idempotent.",
  ...
  },
  {
    ...
    items: [
      "Nalarin.id dapat membagikan data terbatas kepada provider OAuth, penyedia pembayaran, email provider, AI provider, storage provider, hosting provider, atau layanan infrastruktur lain yang diperlukan untuk menjalankan platform.",
      "Data pembayaran diproses bersama penyedia pembayaran atau melalui proses yang diverifikasi admin.",
