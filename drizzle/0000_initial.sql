...
CREATE TABLE `practice_answers` (
	...
	`question_type` enum('multiple_choice','multiple_answer','short_answer','true_false') NOT NULL,
...
CREATE TABLE `questions` (
	...
	`subject_id` int unsigned NOT NULL,
	`topic_id` int unsigned,
	`type` enum('multiple_choice','multiple_answer','short_answer','true_false') NOT NULL,
	`difficulty` enum('easy','medium','hard') NOT NULL,
